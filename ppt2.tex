...
\begin{document}
	...
	\institute{EEE Dept., GEC Barton Hill,Thiruvananthapuram}
	\date{\today}
	...
	\begin{frame}{Hardware Design}
		\begin{figure}[h]
			\centering
			\includegraphics[width=0.6\textwidth]{diag/PCB_compiled.png}
			\caption{PCB Designs}
			\label{fig:bubo}
		\end{figure}
	\end{frame}
	...
	%		\begin{frame}{Hardware Design - Buck and Boost Converters with Monitoring (Contd.) }
		%			\begin{figure}[h]
			%				\centering
			%				\includegraphics[width=0.6\textwidth]{diag/1 pcb.jpg}
	...
	%		\begin{frame}{Hardware Design - Buck and Boost Converters with Monitoring (Contd.) }
		%			\begin{figure}[h]
			%				\centering
			%				\includegraphics[width=0.6\textwidth]{diag/1 3d.jpg}
	...
	%		\begin{frame}{Hardware Design - Battery Charger (Contd.) }
		%			\begin{figure}[h]
			%				\centering
			%				\includegraphics[width=0.6\textwidth]{diag/charg pcb.jpg}
	...
	%		\begin{frame}{Hardware Design - MPPT (Contd.) }
		%			\begin{figure}[h]
			%				\centering
			%				\includegraphics[width=0.6\textwidth]{diag/MpptDemopcb.jpg}
	...
	%		\begin{frame}{Hardware Design - MPPT (Contd.)}
		%			\begin{figure}[h]
			%				\centering
			%				\includegraphics[width=0.6\textwidth]{diag/MpptDemo3d.jpg}
	...
	%		\begin{section}{Bill of Materials}
		...
		\begin{frame}{Fully Integrated EPS}
			\begin{figure}[h]
				\centering
				\includegraphics[width=0.8\textwidth]{diag/EPS_FrontBack.png}
		...
		%    \begin{frame}{Hardware Testing: Battery charger}
			...
			\begin{frame}{Conclusion}
				\begin{itemize}
					...
					\end{itemize}
				\end{itemize}
				%The initial power budget was established to determine the power requirements. The system architecture was designed, considering the functional requirements and scalability. The PCB design, fabrication, and soldering processes was completed and Preliminary testing of all modules were conducted to identify any potential issues or design flaws. Line and load regulation were conducted to measure the limit of stable power delivery. Finally, a fully integrated EPS was designed in KiCad, incorporating improved designs, protection, and monitoring circuits.
				%\end{frame}
			...
			%		\begin{frame}{Project Timeline}
				%			\begin{table}[]
					%				\begin{adjustbox}{totalheight=\textheight-3\baselineskip,center}
						%					\begin{tabular}{|l|l|l|l|l|l|l|l|l|}
							%\hline
							%Activity &
							%  \begin{tabular}[c]{@{}l@{}}Jan\\ week\\ 3-4\end{tabular} &
							%  \begin{tabular}[c]{@{}l@{}}Feb\\ week\\ 1-2\end{tabular} &
							%  \begin{tabular}[c]{@{}l@{}}Feb\\ week\\ 3-4\end{tabular} &
							%  \begin{tabular}[c]{@{}l@{}}Mar\\ week\\ 1-2\end{tabular} &
							%  \begin{tabular}[c]{@{}l@{}}Mar\\ week\\ 3-4\end{tabular} &
							%  \begin{tabular}[c]{@{}l@{}}Apr\\ week\\ 1-2\end{tabular} &
							%  \begin{tabular}[c]{@{}l@{}}Apr\\ week\\ 3-4\end{tabular} &
							%  \begin{tabular}[c]{@{}l@{}}May\\ week\\ 1-3\end{tabular} \\ \hline
							% &
							...
							%   &
							%   \\ \cline{2-9} 
							%\multirow{-2}{*}{PCB design and fabrication} &
				...
				\begin{frame}{Selected References}
					...
					\begin{thebibliography}{9}
						...
						\bibitem[3]{p1}A. Edpuganti, V. Khadkikar, M. S. E. Moursi, H. Zeineldin,  and K. Al Hosani (2022)
